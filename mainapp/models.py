...
class Cart(models.Model):
    ...
    products = models.ManyToManyField(CarProduct, blank=True, related_name='related_cart')
...
class Specification(models.Model):
    ...
    name = models.CharField(max_length=255, verbose_name='Наименование товара для характеристик')
